...
import { Link, type LoaderFunctionArgs, NavLink } from "react-router";
...
const TripDetails = ({ loaderData }: Route.ComponentProps) => {
  ...
  return (
    <main className="travel-detail wrapper relative">
      <NavLink to="/" className="back-link lg:absolute top-4 left-8">
      ...
      <section className="container wrapper-md">
        ...
        <section>
          ...
          <Link to={`/payment/${tripId}`}>
            <ButtonComponent
              type="button"
              className="button-class !h-14 !w-full mt-8"
            >
